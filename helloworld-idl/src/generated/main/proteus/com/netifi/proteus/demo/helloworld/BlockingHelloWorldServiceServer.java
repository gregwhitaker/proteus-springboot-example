...
public final class BlockingHelloWorldServiceServer extends io.netifi.proteus.AbstractProteusService {
  ...
  public BlockingHelloWorldServiceServer(BlockingHelloWorldService service, java.util.Optional<reactor.core.scheduler.Scheduler> scheduler, java.util.Optional<io.micrometer.core.instrument.MeterRegistry> registry) {
    ...
    if (!registry.isPresent()) {
      ...
      this.sayHello = io.netifi.proteus.metrics.ProteusMetrics.timed(registry.get(), "proteus.server", "service", BlockingHelloWorldService.SERVICE_ID, "method", BlockingHelloWorldService.METHOD_SAY_HELLO);
    }
    ...
    try {
      ...
      switch(io.netifi.proteus.frames.ProteusMetadata.getMethod(metadata)) {
        case HelloWorldService.METHOD_SAY_HELLO: {
          ...
          com.netifi.proteus.demo.helloworld.HelloWorldRequest message = com.netifi.proteus.demo.helloworld.HelloWorldRequest.parseFrom(is);
